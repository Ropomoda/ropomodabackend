"""
Django settings for ropomodabackend project.
...
PASSWORDLESS_AUTH = {
    ...
    'PASSWORDLESS_AUTH_PREFIX': 'api/v1/auth/',
    
    #  URL Prefix for Verification Endpoints
    'PASSWORDLESS_VERIFY_PREFIX': 'api/v1/auth/verify/',
...
ROOT_URLCONF = 'ropomodabackend.urls'
...
WSGI_APPLICATION = 'ropomodabackend.wsgi.application'
